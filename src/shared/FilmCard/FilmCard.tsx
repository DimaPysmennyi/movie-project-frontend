...
export function FilmCard(props: IMovieCard){
    return (
        <Link className='movie-link' to={`/movie/${props.id}`}>
            <div key={props.id} className={`film-card ${props.className}`} >
                <div className='film-image' style={{'backgroundImage': `url(${props.previewSrc})`}}>
